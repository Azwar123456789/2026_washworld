...
function useAuth() {
    ...
    const meQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        enabled: ("TURBOPACK compile-time value", "undefined") !== "undefined" && !!localStorage.getItem("token")
    });
    return {
...
;
function LoginPage() {
    const { login, isLoggingIn, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
...
//# sourceMappingURL=app_0cnm5ff._.js.map